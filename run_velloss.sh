...
declare -A STEP=( [1]=2000 [2]=1000 [3]=1000 [4]=8000 [5]=2000 )
run(){ local f=$1 g=$2 s=${STEP[$1]}
  CUDA_VISIBLE_DEVICES=$g python examples/Bitcoin/eval_files/dump_velocity_loss.py \
    ...
    --output_npz results/exp4_velloss/v15_btc_fold${f}.npz --num_draws 20 --batch_size 8 \
    > logs/velloss_fold${f}.log 2>&1; echo "[$(date)] fold${f} done"; }
